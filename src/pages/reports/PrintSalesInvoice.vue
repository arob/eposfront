        ...
        <q-card-section>
          <div class="row q-col-gutter-sm">
            ...
            <div class="col-sm-6 col-md-4 col-xs-6">
              <span class="text-subtitle2">
                Date: {{ new Date(sales_invoice.invoice_created_at).toLocaleString('en-IN') }}
              </span><br>
                INV NO:
              <span class="text-subtitle2">
                <span>{{sales_invoice.invoice_number}}</span>
              </span><br>
              Created by: <span class="text-subtitle2">{{sales_invoice.created_by}}</span><br>
            </div>
          </div>
          <div class="row q-col-gutter-sm">
